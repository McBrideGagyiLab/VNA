function D=bwdistsc(bw,aspect,iter,totIter)
...
p=shape(3);
WAIT_E = waitbar(1/shape(3), strcat('3D Euclidean Distance Transform: ',num2str(iter),'/',num2str(totIter),'...'));
for k=1:shape(3)
    waitbar(k/shape(3), WAIT_E, strcat('3D Euclidean Distance Transform: ',num2str(iter),'/',num2str(totIter),'...'));
